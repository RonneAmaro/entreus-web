...
export const HUB_ITEMS: readonly NavigationItem[] = [
  ...
  { id: 'creator-studio', title: 'Creator Studio', description: 'Conteúdo, métricas e monetização do criador.', href: '/creator-studio', icon: 'creator', category: 'creator', keywords: ['criador', 'dashboard', 'metricas', 'monetizacao'], audience: 'authenticated', accent: 'violet' },
